...
soloModeButton.addEventListener('click', function() { beginGame('solo'); }, false);
computerModeButton.addEventListener('click', function() { beginGame('computer'); }, false);
...
function beginGame(mode) {
	gameMode = mode;
	gameModeDialog.className = 'is-hidden';
	if (gameMode === 'computer') {
		opponentStatus.className = 'is-active';
	} else {
		opponentStatus.className = '';
	}
}
